...
class MusicService: Service(), AudioManager.OnAudioFocusChangeListener {
    ...
    fun showNotification(playPauseBtn: Int){
       ...
       val image = if (imgArt != null){
            ...
            BitmapFactory.decodeResource(resources, R.drawable.easy_music_player_icon_splash_screen)
        }
        ...
        val notification = androidx.core.app.NotificationCompat.Builder(baseContext, ApplicationClass.CHANNEL_ID)
            ...
            .addAction(R.drawable.exit_icon, "Exist",exitPendingIntent)
            .build()
...
//            mediaSession.setPlaybackState(PlaybackStateCompat.Builder()
        ...
        mediaSession.setCallback(object:  MediaSessionCompat.Callback(){
            ...
            //currently on pause or place music on button click
    ...
    fun createMediaPlayer(){
        try {
            ...
            PlayerActivity.nowPlaying = PlayerActivity.musicListPA[PlayerActivity.songposition].id
